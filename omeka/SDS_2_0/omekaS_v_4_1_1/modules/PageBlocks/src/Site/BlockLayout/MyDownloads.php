...
use PageBlocks\Form\MyDownloadsForm;

class MyDownloads extends AbstractBlockLayout
{
    /**
    ...
    {
        return 'My Downloads'; // @translate
    }

    public function form(PhpRenderer $view, SiteRepresentation $site,
        SitePageRepresentation $page = null, SitePageBlockRepresentation $block = null
    ) {
        $form = $this->formElementManager->get(MyDownloadsForm::class);
    ...
    {
        return $view->partial('common/block-layout/mydownloads', [
